...
describe for each I<E<lt>commandE<gt>>, below, under L<COMMANDS>.
...
Many window managers are incapable of providing for key chaining.
...
external keybinders that were assocaiated with a window manager (such as
