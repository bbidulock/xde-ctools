...
L<blackbox(1)>, B<xde-winlist> will do nothing.
...
running under L<icewm(1)>, B<xde-winlist> will do nothing.
...
own and it follows the style of the window manager.  Therefore, when
running under L<metacity(1)>, B<xde-winlist> will do nothing.
...
L<wmaker(1)>, B<xde-winlist> will do nothing.
