...
Provides desktop event sounds as feedback for window managers that do not
...
with a common set of event identifiers so that they can be themed.  The
B<xde-sounds> package provides a default C<freedesktop> sound theme.
See the B<xde-style> and B<xde-theme> packages for more sounds.
...
=item B<_NET_DESKTOP_SHOWING>

=item B<_NET_DESKTOP_BORDER>

=item B<_NET_DESKTOP_MARGIN>
...
=item B<_NET_WM_MOVING>

=item B<_NET_WM_RESIZING>
...
An enhancement was made to L<adwm(1)> to place a C<_NET_WM_MOVING>
property on a window while being moved indicating the nature of the move
of the window.  The appearance of this property can be used to play this
sound.
...
An enhancement was made to L<adwm(1)> to remove the C<_NET_WM_MOVING>
property from a window after it has stopped being moved.  The removal
of this property can be used to play this sound.
...
An enhancement was made to L<adwm(1)> to place a flag in the
C<_NET_WM_MOVING> property on a window when the move was cancelled.  The
flag being placed in the property can be used to play this sound.
...
An enhancement was made to L<adwm(1)> to place a C<_NET_WM_MOVING>
property on a window while being moved indicating the nature of the move
of the window.  The presence of this property can be used to play this
sound.  The value of one of the cardinals of the property indicates the
(nearest) grip from which the move was initiated, the value of which can
be used to choose between the versions of this sound.

=item B<window-move-end-snap>

"A window move has snapped to a boundary and the window has stopped
moving."

An enhancement was made to L<adwm(1)> to place a flag in the
C<_NET_WM_MOVING> property on a window when it snaps to a boundary while
moving.  This flag in the property can be used to play this sound.

=item B<window-move-start-unsnap>

"A window move has unsnapped from a boundary and the window has resumed
moving."

An enhancement was made to L<adwm(1)> to place a flag in the
C<_NET_WM_MOVING> property on a window when it unsnaps from a boundary
while moving.  This flag in the property can be used to play this sound.
...
An enhancement will be made to L<adwm(1)> to place a C<_NET_WM_RESIZING>
property on a window while being resized indicating the nature of the
resize of the window.  The appearance of this property can be used to
play this sound.
...
An enhancement was made to L<adwm(1)> to remove the C<_NET_WM_RESIZING>
property from a window after it has stopped being resized.  The removal
of this property can be used to play this sound.
...
An enhancement was made to L<adwm(1)> to place a flag in the
C<_NET_WM_RESIZING> property on a window when the resize was cancelled.  The
flag being placed in the property can be used to play this sound.
...
An enhancement was made to L<adwm(1)> to palce a C<_NET_WM_RESIZING>
property on a window while being resized indicating the nature of the
resize of the window.  The presence of this property can be used to play
this sound.  The value of one of the cardinals of the property indicates
the (nearest) grip from which the resize was initiated, the value of
which can be used to choose between the versions of this sound.

=item B<window-resize-end-snap>

"A window resize has snapped to a boundary and the window has stopped
resizing."

An enhancement was made to L<adwm(1)> to place a flag in the
C<_NET_WM_RESIZING> property on a window when it snaps to a boundary while
resizing.  This flag in the property can be used to play this sound.

=item B<window-resize-start-unsnap>

"A window resize has unsnapped from a boundary and the window has resumed
resizing."

An enhancement was made to L<adwm(1)> to place a flag in the
C<_NET_WM_RESIZING> property on a window when it unsnaps from a boundary
while resizing.  This flag in the property can be used to play this sound.
...
L<adwm(1)> was enhanced to set an array of cardinals in a
B<_NET_DESKTOP_SHOWING> property on the root window.  Changes to this
property can be used to generate this sound.
...
L<adwm(1)> was enhanced to set the border width in a
B<_NET_DESKTOP_BORDER> property on the root window.  Changes to this
property can be used to generate this sound.
...
L<adwm(1)> was enhanced to set the margin width in a
B<_NET_DESKTOP_MARGIN> property on the root window.  Changes to this
property can be used to generate this sound.
