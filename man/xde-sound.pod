...
responsibility of the GUI toolkit and are not detected or invoked by
B<xde-sound>.
...
=item I<window-stick>, I<window-unfloat> (I<window-stick-unfloat>?)

=item I<window-unstick>, I<window-float> (I<window-unstick-float>?)
