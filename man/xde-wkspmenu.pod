...
L<2bwm(1)> does not provide window cycling feedback of its own.
L<2bwm(1)> is supported and should work well.

=item L<adwm(1)>

L<adwm(1)> does not provide window cycling feedback of its own.
L<adwm(1)> is supported and should work well.

=item L<aewm(1)>

L<aewm(1)> does not provide window cycling feedback of its own.
...
L<awesome(1)> does not provide window cycling feedback of its own.
L<awesome(1)> is supported and should work well.

=item L<blackbox(1)>

L<blackbox(1)>, when run with L<bbkeys(1)>, provides an adequate window
cycling feedback pop-up of its own and it follows the style of the
window manager.  (Its only real shortcoming is that the feedback window
cannot be centred on the screen or monitor and must be absolutely placed
in the L<bbkeys(1)> configuration file.) When running under
L<blackbox(1)>, B<xde-wkspmenu> will do nothing.

=item L<bspwm(1)>

L<bspwm(1)> does not provide window cycling feedback of its own.
...
L<echinus(1)> does not provide window cycling feedback of its own.
L<echinus(1)> is supported and should work well.

=item L<etwm(1)>

L<etwm(1)> does not provide window cycling feedback of its own.
...
L<fluxbox(1)> does not provide window cycling feedback of its own.
...
L<fvwm(1)> does not provide window cycling feedback of its own.
...
L<goomwwm(1)> does not provide window cycling feedback of its own.
L<goomwwm(1)> is supported and should work well.

=item L<herbstluftwm(1)>

L<herbstluftwm(1)> does not provide window cycling feedback of its own.
L<herbstluftwm(1)> is supported and should work well.

=item L<i3(1)>

L<i3(1)> does not provide window cycling feedback of its own.
L<i3(1)> is supported and should work well.

=item L<icewm(1)>

L<icewm(1)> provides an adequate window cycling feedback pop-up of its
own and it follows the style of the window manager.  Therefore, when
running under L<icewm(1)>, B<xde-wkspmenu> will do nothing.

=item L<jwm(1)>

L<jwm(1)> does not provide window cycling feedback of its own.
...
L<matwm2(1)> does not provide window cycling feedback of its own.
L<matwm2(1)> is supported and should work well.

=item L<metacity(1)>

L<metacity(1)> provides an adequate window cycling feedback pop-up of its
own and it follows the style of the window manager.  Therefore, when
running under L<metacity(1)>, B<xde-wkspmenu> will do nothing.

=item L<mvwm(1)>

L<mvwm(1)> does not provide window cycling feedback of its own.
...
L<openbox(1)> does not provide window cycling feedback of its own.
L<openbox(1)> is supported and should work well.

=item L<pekwm(1)>

L<pekwm(1)> does not provide window cycling feedback of its own.
...
L<uwm(1)> does not provide window cycling feedback of its own.
...
L<waimea(1)> does not provide window cycling feedback of its own.
...
L<wind(1)> does not provide window cycling feedback of its own.
...
L<wmaker(1)> provides an adequate window cycling feedback pop-up of its
own and it follows the theme of the window manager.  When running under
L<wmaker(1)>, B<xde-wkspmenu> will do nothing.

=item L<wmii(1)>

L<wmii(1)> does not provide window cycling feedback of its own.
L<wmii(1)> is supported and should work well.

=item L<wmx(1)>

L<wmx(1)> does not provide window cycling feedback of its own.
...
provided by F<libwnk>) do not support the special features associated
