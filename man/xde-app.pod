...
Provides a XDG application launcher command dialog for running
freedesktop.org applications as though from the command line using a
graphical utility.
...
requested and launch the application launch command dialog.
