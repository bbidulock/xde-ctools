...
#define XDE_DESCRIP		"An XDG compliant places menu."
...
Options:\n\
    ...
    -l, --label LABEL\n\
        specify the label for the menu [default: %15$s]\n\
    -t, --tooltips\n\
...
main(int argc, char *argv[])
{
	...
	while (1) {
		...
		c = getopt_long_only(argc, argv, "d:s:M:pf:T:PKb:w:W:l:tD::v::hVC?",
				     long_options, &option_index);
#else				/* _GNU_SOURCE */
		c = getopt(argc, argv, "d:s:M:pf:T:PKb:w:W:l:tD:vhVC?");
#endif				/* _GNU_SOURCE */
		if (c == -1) {
